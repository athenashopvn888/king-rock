...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "King Rock Cannabis Price And Flower Tier Guide for Adults 19+",
    seoTitle: "King Rock Cannabis Price Tier Guide | Adult 19+",
    seo_title: "King Rock Cannabis Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to King Rock Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Adult 19+ guide to King Rock Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "King Rock Cannabis Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to King Rock Cannabis flower tiers, weights, and unit value.",
    author: "The King Rock Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## King Rock Cannabis Price And Flower Tier Guide for Adults 19+

King Rock Cannabis keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.
...
For the smoothest visit, open the King Rock Cannabis menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.
...
- Browse the King Rock Cannabis store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand King Rock Cannabis flower tiers before visiting.`,
    faq: "",
    internal_links_used: "[King Rock Cannabis store page](/weed-dispensary-toronto)\\n[King Rock Cannabis homepage](/)\\n[More King Rock Cannabis guides](/blog)",
    relatedLinks: [
      {
      ...
      {
        title: "King Rock Cannabis homepage",
        url: "https://kingrockcannabis.com/",
        description: "Store-scoped homepage navigation for adults 19+."
      },
      {
        title: "More King Rock Cannabis guides",
        url: "https://kingrockcannabis.com/blog",
