...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    title: "King Rock Local Store Guide for Adults 19+",
    seoTitle: "King Rock Guide | Toronto Adult 19+",
    seo_title: "King Rock Guide | Toronto Adult 19+",
    metaDescription: "Adult 19+ guide to King Rock around Liberty Village / Parkdale, with local store-page checks, menu-category context, and safe visit planning.",
    meta_description: "Adult 19+ guide to King Rock around Liberty Village / Parkdale, with local store-page checks, menu-category context, and safe visit planning.",
    h1: "King Rock Local Store Guide for Adults 19+",
    excerpt: "King Rock guide for adults 19+ reviewing store information around Liberty Village / Parkdale.",
    author: "The King Rock Team",
    date: "2026-07-02",
    category: "Store Guide",
    readTime: "4 min",
    content: `## King Rock Local Store Guide for Adults 19+

King Rock serves adults 19+ looking for store information around Liberty Village / Parkdale. Use this guide to get oriented, compare the store page with menu categories, and choose the most useful next step before visiting.
...
King Rock is tied to King St W and Liberty Village context in Toronto. Useful local content should make the page easier for shoppers to understand by connecting the store to nearby streets, neighbourhood language, and visit-planning details already supported by the site.
...
Start with the official King Rock store page, then use the menu/category links to browse what the site makes easy to compare. Shoppers can confirm the right storefront, directions, contact options, and local visit details in one place.
...
### Is this guide for King Rock only?

Yes. This guide is written for King Rock and the local Toronto context connected to this website.
...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
    faq: "",
    internal_links_used: "[King Rock Toronto store page](/weed-dispensary-toronto)\\n[King Rock homepage](/)\\n[More King Rock guides](/blog)",
    relatedLinks: [
      {
            "title": "King Rock Toronto store page",
            "url": "https://kingrockcannabis.com/weed-dispensary-toronto",
      ...
      },
      {
            ...
            "url": "https://kingrockcannabis.com/blog",
  ...
  },
  {
    ...
    title: "King Rock Cannabis Price and Flower Tier Guide",
    seoTitle: "King Rock Cannabis Price Tier Guide",
    seo_title: "King Rock Cannabis Price Tier Guide",
    metaDescription: "King Rock Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "King Rock Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "King Rock Cannabis Price and Flower Tier Guide",
    excerpt: "A simple guide to King Rock Cannabis flower tiers, weights, and unit value.",
    author: "The King Rock Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## King Rock Cannabis Price and Flower Tier Guide

King Rock Cannabis makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the King Rock Cannabis menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.
...
- Open the King Rock Cannabis store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    title: "King Rock Local Visit Guide for Adults 19+",
    seoTitle: "King Rock Local Visit Guide | Toronto Adult 19+",
    seo_title: "King Rock Local Visit Guide | Toronto Adult 19+",
    metaDescription: "Plan a visit to King Rock in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to King Rock in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    h1: "King Rock Local Visit Guide for Adults 19+",
    excerpt: "King Rock guide for adults 19+ checking local context, store pages, and menu-category paths around Liberty Village / Parkdale.",
    author: "The King Rock Team",
    date: "2026-07-09",
    category: "Local Guide",
    readTime: "5 min",
    content: `Use this guide to confirm the right King Rock storefront around Liberty Village / Parkdale, understand nearby street context, and choose the most useful store page or menu path before visiting.

For current details, start with the official store page or contact staff before leaving.

## Confirm The Right Storefront

King Rock is tied to Liberty Village, Parkdale, Toronto, nearby local roads. Local shoppers often compare several nearby search results, so the first job of this page is to make the store identity, area context, and next click easy to understand.
...
Searches near Liberty Village / Parkdale usually come from shoppers who already have a real-world route in mind. Mentioning nearby streets, neighbourhood language, and local travel context helps the page match how people actually search without inventing claims.
...
- Open the King Rock store page: [https://www.kingrockcannabis.com/weed-dispensary-toronto](https://www.kingrockcannabis.com/weed-dispensary-toronto)
- Browse more local guides from the blog: [https://www.kingrockcannabis.com/blog](https://www.kingrockcannabis.com/blog)
- Confirm store-specific details before heading out.

## FAQ

### Is this guide only for King Rock?

Yes. This page is written for King Rock and the Liberty Village / Parkdale area.
...
Local shoppers search with neighbourhood and street language. Clear local context helps them confirm they are looking at the right store.`,
    ...
    internal_links_used: "/weed-dispensary-toronto, /blog, /blog/king-rock-local-visit-guide-2026",
    relatedLinks:     [
          {
                "title": "King Rock store page",
                "url": "https://www.kingrockcannabis.com/weed-dispensary-toronto",
                "description": "Official King Rock page for local visit planning."
          },
          {
                "title": "King Rock homepage",
                "url": "https://www.kingrockcannabis.com/",
                "description": "Start from the King Rock homepage."
          },
          {
                "title": "More King Rock guides",
