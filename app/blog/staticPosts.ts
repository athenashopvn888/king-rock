...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a King Rock Visit Without Guessing",
    "seoTitle": "King Rock Visit Guide | Weed Dispensary in Toronto",
    "seo_title": "King Rock Visit Guide | Weed Dispensary in Toronto",
    "metaDescription": "Plan a King West visit to King Rock with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a King West visit to King Rock with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a King Rock Visit Without Guessing",
    "excerpt": "A practical visit guide for King Rock, written for shoppers who want the next step without the runaround.",
    "author": "Roman King",
  ...
  },
  {
    ...
    "title": "How to Compare King Rock Flower Without Guessing",
    "seoTitle": "King Rock Flower Guide | Budget to Exotic",
    "seo_title": "King Rock Flower Guide | Budget to Exotic",
    "metaDescription": "Compare King Rock flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare King Rock flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare King Rock Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at King Rock.",
    "author": "Roxy Stone",
    "authorName": "Roxy Stone",
    "authorHandle": "@RoxyKingRock",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "title": "How to Shop the King Rock Menu Like a Pro",
    "seoTitle": "King Rock Menu Guide | Toronto Weed Store",
    "seo_title": "King Rock Menu Guide | Toronto Weed Store",
    "metaDescription": "Shop the King Rock menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the King Rock menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the King Rock Menu Like a Pro",
    "excerpt": "A natural guide to shopping the King Rock menu without turning the visit into a guessing game.",
    "author": "Roman King",
    "authorName": "Roman King",
    "authorHandle": "@RomanKingRock",
    "authorRole": "House Writer",
