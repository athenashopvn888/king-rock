...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about King Rock in Toronto. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://king-rock.com/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is King Rock located?", a: "We are located at 1220b King St W, Toronto, ON M6K 1G4. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to King Rock?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at king-rock.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! King Rock is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 01:00 AM." },
      { q: "Can I order online?", a: "Currently, King Rock is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about King Rock — Toronto&apos;s premium dispensary at 1220b King St W in Toronto.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(437) 236-3469</strong> or visit us at 1220b King St W, Toronto.
            </p>
            <a
