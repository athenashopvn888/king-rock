...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at King Rock?", a: "Yes! Visit us at 1220b King St W, Toronto. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  PREROLLS: {
    ...
    seoDescription: "Skip the rolling and grab a pre-roll from King Rock in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 1220b King St W — open daily 24 hours.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "King Rock is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1220b King St W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
