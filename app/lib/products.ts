...
> = {
  EXOTIC: {
    ...
    color: "#f59e0b",
    icon: "\uD83D\uDD25",
    tagline: "Explore the Weed Exotic flower collection",
  ...
  PREMIUM: {
    ...
    color: "#a78bfa",
    icon: "\uD83D\uDC8E",
    tagline: "Explore the Weed Premium flower collection",
  ...
  "AAA+": {
    ...
    color: "#22d3ee",
    icon: "\u26A1",
    tagline: "Explore the Weed AAA+ flower collection",
  ...
  AA: {
    ...
    color: "#34d399",
    icon: "\u2726",
    tagline: "Explore the Weed AA flower collection",
  ...
  BUDGET: {
    ...
    color: "#94a3b8",
    icon: "\uD83D\uDCB0",
    tagline: "Explore the Weed Budget flower collection",
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE PENS": {
    ...
    color: "#8b5cf6",
    icon: "NV",
    seoTitle: "Nicotine Vapes Toronto | King Rock",
    seoIntro: "Explore King Rock nicotine vape products in a category kept separate from THC Vape products. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    seoDescription: "King Rock keeps Nicotine Vape and THC Vape distinct so shoppers can clearly identify which type of product they are browsing. Use the product information presented with individual items to learn more while exploring the nicotine category.",
    faqs: [
