...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at King Rock?", a: "Yes! Visit us at 1220b King St W, Toronto. We're open daily from 10:00 AM to 02:00 AM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  CIGARETTES: {
    ...
    seoDescription: "King Rock is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 1220b King St W in the heart of 1220b King St W & Nearby Expressway, we're Open Daily: 10:00 AM - 02:00 AM.",
    faqs: [
