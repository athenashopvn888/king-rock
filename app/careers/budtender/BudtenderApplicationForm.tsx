...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at King Rock" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="KR01" />
      <input type="hidden" name="StoreName" value="King Rock" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at King Rock?</span>
