...
function previewStatus(): StaffStatus {
  return {
    store: { code: "KR01", name: "King Rock" }, dayKey: "2026-07-23", submissions: [],
  ...
  if (!authenticated) return (
    <main className={styles.shell}>
      <section className={styles.loginCard} aria-labelledby="login-title">
        ...
        <p className={styles.eyebrow}>KR01 · Staff only</p>
        <h1 id="login-title">Today’s store task</h1>
        <p className={styles.intro}>Enter the King Rock staff PIN.</p>
  ...
  return (
    <main className={styles.shell}>
      <header className={styles.header}>
        <div><p className={styles.eyebrow}>KR01 · Staff</p><h1>Today’s store task</h1><p>{status?.dayKey}</p></div>
