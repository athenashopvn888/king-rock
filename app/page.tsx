...
const LOCAL_FAQS = [
  {
    ...
    a: "King Rock at 1220b King St W, Toronto is open daily from 10:00 AM to 02:00 AM. Walk in anytime — no appointment needed.",
  },
  {
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>1220b King St W & Nearby Expressway's Premier Cannabis Dispensary — Open Daily: 10:00 AM - 02:00 AM</h2>
            ...
            <p className={styles.seoPanelText}>
              We are open Open Daily: 10:00 AM - 02:00 AM — King Rock is here to serve you. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down or stocking up for the weekend, our knowledgeable staff is always here for you.
            </p>
            <p className={styles.seoPanelText}>
