"""
King Rock - Auto Sync from Google Sheets
==========================================
...
a filtered menu for King Rock (ALC01).
...
def main():
    print("=" * 60)
    print(f"  King Rock - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://king-rock.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
