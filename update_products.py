"""
King Rock — Product Update Script
===================================
Drop your ONHAND CSV into the king-rock folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  King Rock — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://king-rock.com")
    else:
